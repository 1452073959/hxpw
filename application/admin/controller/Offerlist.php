            ...
            foreach($content as $k=>$v){
                ...
                foreach($need_material as $one_material){
                    if($one_material[0] && $one_material[1]){
                        ...
                        $materials_info = Db::name('materials')->where(array('frameid'=>$userinfo['companyid'],'name'=>$one_material[0]))->whereOr(array('frameid'=>$userinfo['companyid'],'amcode'=>$one_material[0]))->find();
