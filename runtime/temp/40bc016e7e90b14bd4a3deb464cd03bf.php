<?php /*a:2:{s:80:"/www/wwwroot/www.hxpw1998.com/application/admin/view/offerlist/baojiaguanli.html";i:1563590298;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <blockquote class="layui-elem-quote news_search">
                <div class="layui-inline">
                 ...
                 <div class="layui-input-inline" style="margin-left: 100px;">
                   <form method="get" action="<?php echo url('Offerlist/baojiaguanli'); ?>" class="form-signin" enctype="multipart/form-data">
                ...
                <thead >
                    <tr>
                      ...
                      <?php endif; ?>
                        ...
                        <!-- <th class="taleft" lay-data="{field:'history',width:150}">历史记录</th> -->
                    </tr>
                </thead>
                <tbody> 
                  ...
                  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                    <tr>
                      ...
                      <td>
                       <a class="layui-btn layui-btn-xs" href="<?php echo url('admin/offerlist/edit',['id'=>$vo['id']]); ?>">选择</a>
                      </td>
                      <td class="taleft"><?php echo htmlentities($vo['id']); ?></td>    
