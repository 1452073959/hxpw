<?php /*a:2:{s:74:"/www/wwwroot/www.hxpw1998.com/application/admin/view/quote/checkmould.html";i:1563956552;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
          ...
          <table class="layui-table mould"> 
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
					...
					<input class="form-control" type="text" placeholder="请输入模板名称" value="<?php echo htmlentities($data['mouldname']); ?>" required="" name="mouldname" />
                    <button class="layui-btn save" target-form="form-horizontal">保存模板</button>
                    <!--<button class="layui-btn saveas" target-form="form-horizontal">另存为新模板</button>-->
                </div>
            </div>
        </form>
		</div>
...
<script type="text/javascript">
    $(document).ready(function(){
       //搜索
		...
		//选择定额数据
		$('#offerlistform').on('mouseover','tr',function(){$(this).css({cursor:'pointer'})});
		...
		$('button.save').click(function(){
			...
			data['type'] = 'save';
            $.ajax({
                url:"<?php echo url('admin/quote/savemould','type=save'); ?>",
                type:"post",
                data:data,
                success:function(result){
                    alert(result.msg)
