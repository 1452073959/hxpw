<?php /*a:2:{s:74:"/www/wwwroot/www.hxpw1998.com/application/admin/view/settlement/index.html";i:1560739760;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
                  ...
                  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                    <tr>
                     ...
                     <!--  <td class="taleft"><?php echo htmlentities($vo['direct_cost']); ?></td>   
                      ...
                      <td class="taleft">
                        <a class="layui-btn layui-btn-xs layui-btn-warm" href="<?php echo url('admin/Settlement/contrast',['id'=>$vo['id']]); ?>">点击查看</a></td>
                     <!--  <td>
