<?php /*a:2:{s:73:"/www/wwwroot/www.hxpw1998.com/application/admin/view/bcontrast/index.html";i:1562753919;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <blockquote class="layui-elem-quote news_search">
                <div class="layui-inline">
                 ...
                 <div class="layui-input-inline" style="margin-left: 100px;">
                   <form method="post" action="<?php echo url('Bcontrast/index'); ?>" class="form-signin" enctype="multipart/form-data">
                ...
                <tbody> 
                  ...
                  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                    <tr>
                      ...
                      <td class="taleft">
                        <a class="layui-btn layui-btn-xs layui-btn-warm" href="<?php echo url('admin/Bcontrast/singlelist',['id'=>$vo['id']]); ?>">进入对比</a></td>
                     <!--  <td>
