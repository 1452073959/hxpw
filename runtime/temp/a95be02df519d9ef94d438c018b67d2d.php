<?php /*a:2:{s:73:"/www/wwwroot/www.hxpw1998.com/application/admin/view/offerlist/index.html";i:1563590393;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
                 ...
                 <!-- <div class="layui-input-inline" style="margin-left: 100px;">
                   <form method="post" action="<?php echo url('Offerlist/index'); ?>" class="layui-form form-signin" enctype="multipart/form-data">
                    ...
                    <input type="submit" value="搜索" class="layui-btn layui-btn-sm daorus">
								...
								<!-- <div class="layui-input-inline" style="margin-left: 100px;">
						<form class="layui-form" method="post" action="<?php echo url('Offerlist/index'); ?>" class="layui-form form-signin" enctype="multipart/form-data">
                    <div class="layui-inline">
												<input type="text" name="search['customer_name']" placeholder="客户姓名" class="layui-input">
                    </div>
                    <div class="layui-inline">
            ...
            <table class="layui-table" lay-filter="test3"  lay-data="{id: '#test3',toolbar:'#',limit:20}">
                ...
                <thead >
                    <tr>
                        ...
                        <th class="taleft" lay-data="{field:'history',width:150}">查看报表</th>
                ...
                <tbody> 
                  ...
                  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                    <tr>   
                      ...
                      <td class="taleft">
												<?php if(input('type') == 'edit'): ?>
												<a class="layui-btn layui-btn-xs" href="<?php echo url('admin/offerlist/zengjian',['id'=>$vo['id'],'report_id'=>$vo['id']]); ?>">选择</a>
												<?php else: ?>
												<a class="layui-btn layui-btn-xs layui-btn-warm" href="<?php echo url('admin/offerlist/history',['customerid'=>$vo['customerid'],'report_id'=>$vo['id']]); ?>">点击查看</a>
												<?php endif; ?>
												</td> 
											<td>
