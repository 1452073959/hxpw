<?php /*a:2:{s:83:"/www/wwwroot/www.hxpw1998.com/application/admin/view/auth_manager/managergroup.html";i:1562554337;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <form class="layui-form form-horizontal" action="<?php echo url('admin/AuthManager/writeGroup'); ?>" method="post">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <a class="layui-btn layui-btn-normal" href="<?php echo url('admin/AuthManager/index'); ?>">返回</a>
                </div>
            </div>
        </form>
    </div>
