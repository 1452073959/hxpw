<?php /*a:2:{s:69:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index/index.html";i:1551760424;s:64:"/www/wwwroot/www.hxpw1998.com/application/admin/view/layout.html";i:1562405344;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link rel="stylesheet" href="/static/12/admin/css/app.css">
    <link rel="stylesheet" href="/static/layui/css/themes/default.css" media="all" id="skin" kit-skin/>
    <script type="text/javascript" src="/static/12/admin/js/jquery-2.0.0.js"></script>
    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right kit-nav">
                <!-- <li  id="notice_btn" class="layui-nav-item layui-icon layui-icon-notice layui-this" style="margin-left:10px;padding:0 10px;position: relative;">
         
                    <i></i>
                <!--有新消息时加hasNews类名，没有新消息去掉类名-->
               <!-- </li> -->
             <!--    <li class="layui-nav-item color-select">
                <a href="javascript:;">
                ...
                <dl class="layui-nav-child skin">
                    ...
                    <dd>
                        <a href="javascript:;" data-skin="blue" style="color:#00c0ef;"><i class="layui-icon">&#xe658;</i> 天空蓝</a>
                    </dd>
                    <dd>
...
$('dl.skin > dd').on('click', function () {
    ...
    initSkin    = function () {
        var skin = "<?php echo htmlentities(app('session')->get('admin_user_auth.color')); ?>";
        switchSkin(skin === undefined ? 'default' : skin);
    }();
    // function setSkin(color)
    // {
    //     $.post('/admin/index/set_color', {color : color}, function (data) {}, 'json');
    // }
</script>
        ...
        <div class="layui-footer">
            ©报价后台 v<?php echo htmlentities(app('config')->get('version.yzncms_version')); ?>
        </div>
    </div>
    ...
    layui.use(['element', 'layer', 'jquery'], function() {
        ...
        $('#notice_btn').on('click', function() {
            $('#notice_btn a').trigger('click');
        })
        $("#notice_btn").on('click','a', function(e) {
            e.preventDefault();
            e.stopPropagation();
            //iframe_height();
            var $this = $(this),
