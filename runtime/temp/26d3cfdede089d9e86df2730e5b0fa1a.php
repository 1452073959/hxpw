<?php /*a:2:{s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/manager/edit.html";i:1552718708;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-card-body">
        <form class="layui-form form-horizontal" action="<?php echo url('admin/manager/edit'); ?>" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="nickname" lay-verify="name" autocomplete="off" placeholder="真实姓名" class="layui-input" value="<?php echo htmlentities($data['name']); ?>">
                </div>
            </div>
            <div class="layui-form-item">
