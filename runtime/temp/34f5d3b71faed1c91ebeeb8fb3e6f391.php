<?php /*a:2:{s:72:"/www/wwwroot/www.hxpw1998.com/application/admin/view/offerlist/edit.html";i:1563956460;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-card">
    <div class="layui-card-header">
			...
			<a class="layui-btn layui-btn-sm choosecustomer" href="<?php echo url('admin/offerlist/baojiaguanli',['type'=>'edit']); ?>">选择客户</a>
    ...
    <div class="layui-card-body">
        ...
        <form id="myform" class="form-horizontal" action="<?php echo url('admin/Offerlist/edit'); ?>" method="post">
          ...
          <table class="layui-table mould"> 
                ...
                <tbody> 
								<?php if(empty($mould) || (($mould instanceof \think\Collection || $mould instanceof \think\Paginator ) && $mould->isEmpty())): ?>
                    <tr data-cate="">
												<td></td>
												<td colspan="1">
								...
								<?php else: if(is_array($mould['details']) || $mould['details'] instanceof \think\Collection || $mould['details'] instanceof \think\Paginator): if( count($mould['details'])==0 ) : echo "" ;else: foreach($mould['details'] as $key=>$vos): ?>
												<tr data-cate="tr<?php echo htmlentities($key); ?>">
													...
													<td colspan="7">
														...
														<a class="layui-btn layui-btn-xs getofferlist" data-selector="getdata" data-conditionsid="<?php echo htmlentities($key); ?>" data-roomid="">获取数据</a>
													</td>
												</tr>
												<?php if(is_array($vos['son']) || $vos['son'] instanceof \think\Collection || $vos['son'] instanceof \think\Paginator): if( count($vos['son'])==0 ) : echo "" ;else: foreach($vos['son'] as $k=>$v): ?>
													<tr id="tr<?php echo htmlentities($k); ?>">
                                                      	<td></td>
														<td colspan="8" class="text-center"><?php echo htmlentities($v['roomname']); ?>
													...
													<?php if(is_array($v['item']) || $v['item'] instanceof \think\Collection || $v['item'] instanceof \think\Paginator): if( count($v['item'])==0 ) : echo "" ;else: foreach($v['item'] as $kk=>$vv): ?>
														<tr class="tr<?php echo htmlentities($key); ?><?php echo htmlentities($k); ?>">
                                                          	<td></td>
															<td colspan="1"><?php echo htmlentities($vv['project']); ?>
                                                              ...
                                                              <!--<a class="layui-btn layui-btn-sm deletequote" data-cate="tr<?php echo htmlentities($key); ?>'" data-parent="tr<?php echo htmlentities($key); ?><?php echo htmlentities($k); ?>">删除</a>--></td>
  ...
  function total(){
      $('tr').each(function(){
        ...
        $(document).on('change','input[name*="gcl"]',function(){
          ...
          console.log(fd);
          console.log(rd);
            $(this).parent().parent().find('td').eq(4).html(Math.round(gcl*fd * 100)/100);
            $(this).parent().parent().find('td').eq(6).html(Math.round(gcl*rd*100)/100);
        });
