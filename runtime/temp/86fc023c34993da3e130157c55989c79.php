<?php /*a:2:{s:79:"/www/wwwroot/www.hxpw1998.com/application/admin/view/artificial/gcfx_index.html";i:1560995390;s:70:"/www/wwwroot/www.hxpw1998.com/application/admin/view/index_layout.html";i:1556248450;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="layui-form">
            ...
            <blockquote class="layui-elem-quote news_search">
                 <div class="layui-input-inline" style="margin-left: 100px;">
                   <form method="post" action="<?php echo url('artificial/gcfx_index'); ?>" class="form-signin" enctype="multipart/form-data">
            ...
            <table class="layui-table" lay-filter="test3"  lay-data="{id: '#test3',toolbar:'#',limit:20}">
                ...
                <thead >
                    <tr>
                        ...
                        <th class="taleft" lay-data="{field:'tubemoney',width:100 }">管理费</th>
                        <th class="taleft" lay-data="{field:'taxes',width:100 }">税金</th>
                        <th class="taleft" lay-data="{field:'discount',width:100 }">优惠</th>
                ...
                <tbody> 
                  ...
                  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                    <tr>
                      ...
                      <td>
                       <a class="layui-btn layui-btn-xs" href="<?php echo url('admin/artificial/gcfx',['customerid'=>$vo['customerid']]); ?>">查看分析表</a>
                      </td>
                    </tr>       
